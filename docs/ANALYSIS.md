{
  "preprocess": {
    ...
    "sha256": "353d8a5a068a893b01e6bcef8dafd20649cc259f74da69adda0246e379acdd02",
    "lines": 16760,
    "bytes": 785448,
  ...
  "lex": {
    ...
    "comment_chars": 176830,
    "string_literal_count": 6279,
    "env_vars": [
      "LEERIE_CAPTURE_DEPS",
      "LEERIE_CLARIFY",
  ...
  "functions": [
    ...
    },
    {
      ...
      "returns": "None",
      "doc": "Periodically `waitpid` orphaned descendants that reparented to this"
    },
    {
...
=== orchestrator/leerie.py sha=353d8a5a068a ===
lines=16760 tokens=81626 ast_nodes=67463 functions=260 classes=8 constants=168
